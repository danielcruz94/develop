export const seguridadsocial = [
    ...
    { value: 'MedicinaPrepagada', label: 'Medicina Prepagada', type: 'text', Help: 'Elige tu plan de salud privado que te permite acceder a servicios médicos de calidad con mayor rapidez, mediante un contrato con una aseguradora que cubre consultas, tratamientos y otros servicios.', visible: false },
    ...
    { value: 'FondoCesantias', label: 'Fondo Cesantías', type: 'text', Help: 'Indica el fondo al cual estás afiliado para el manejo de tus cesantías. Las cesantías son un ahorro obligatorio que el empleador debe consignar en favor del trabajador, utilizado principalmente en casos de desempleo.', visible: false },
  ...
  export const ingresos = [
    ...
    { value: 'PrimaDeServicios', label: 'Prima de Servicios', Help: 'Es un pago adicional que se otorga a los trabajadores en ciertos periodos del año, como parte de la compensación por su trabajo. Usualmente se paga en diciembre y junio.', visible: true, type: "number" },
    { value: 'PrimaExtralegal', label: 'Prima Extralegal', Help: 'Es una bonificación adicional que puede ser otorgada por el empleador, fuera de lo que estipula la ley. No es obligatoria y depende de las políticas de la empresa.', visible: true, type: "number" },
    ...
    { value: 'SubsidioDeTransporte', label: 'Subsidio de Transporte', Help: 'Es un pago otorgado para cubrir el costo del transporte desde y hacia el lugar de trabajo. En muchos países es un beneficio no sujeto a impuestos.', visible: true, type: "number" },
    { value: 'SubsidioFamiliar', label: 'Subsidio Familiar', Help: 'Beneficio económico otorgado a los trabajadores para apoyar los gastos familiares, como el cuidado de hijos o personas dependientes.', visible: true, type: "number" }
];

export const ahorro = [
    { value: 'CuentaCorriente', label: 'Cuenta Corriente', Help: 'Es una cuenta bancaria destinada para transacciones diarias, como pagos, depósitos y retiros. Generalmente, no tiene restricciones de acceso, pero puede tener costos asociados.', visible: true, type: "number" },
    { value: 'CuentaDeAhorros', label: 'Cuenta de Ahorros', Help: 'Es una cuenta bancaria en la que puedes depositar dinero y ganar intereses. Está destinada principalmente para ahorrar a largo plazo.', visible: true, type: "number" },
    ...
    { value: 'FondoDeEmpleados', label: 'Fondo de Empleados', Help: 'Es un fondo creado por una empresa para ofrecer a sus empleados un beneficio económico, que generalmente se destina a ahorros, préstamos o seguros.', visible: true, type: "number" },
    { value: 'inversionesExterior', label: 'Inversiones Exterior', Help: 'Se refiere a colocar recursos en activos fuera del país de residencia, como en mercados internacionales, para diversificar las fuentes de ingreso y reducir riesgos.', visible: true, type: "number" },
    { value: 'CarteraColectiva', label: 'Cartera Colectiva', Help: 'Es un conjunto de inversiones de diferentes personas administrado por una entidad financiera. Los inversores reciben una parte de los ingresos generados de acuerdo con su participación.', visible: true, type: "number" },
    ...
    { value: 'CuentaAFC', label: 'Cuenta AFC', Help: 'Es una cuenta especial diseñada para el ahorro de los trabajadores para la compra de vivienda, permitiendo ahorrar de forma voluntaria y con beneficios fiscales en algunos países.', visible: true, type: "number" },
    { value: 'FondosMutuos', label: 'Fondos Mutuos', Help: 'Son vehículos de inversión colectiva que agrupan el dinero de varios inversionistas para invertir en activos como acciones, bonos y otros valores. Los fondos mutuos permiten diversificar el riesgo de inversión.', visible: true, type: "number" },
    { value: 'PensionVoluntaria', label: 'Pensión Voluntaria', Help: 'Es un tipo de ahorro adicional que puedes hacer de manera voluntaria para incrementar tu pensión en la jubilación, aportando dinero de forma periódica a una entidad financiera.', visible: true, type: "number" },
    { value: 'ProvisionAnualidades', label: 'Provisión Anualidades', Help: 'Es un ahorro destinado a generar ingresos de forma periódica, generalmente como una fuente de renta a largo plazo, como en el caso de una pensión.', visible: true, type: "number" },
...
export const gastosPersonales = [
  { value: 'AlmuerzosDiarios', label: 'Almuerzos Diarios', Help: 'Es el gasto diario relacionado con la comida durante la jornada laboral o escolar. Incluye el costo de comprar almuerzos fuera de casa o llevar comida preparada.', visible: false, type: "number" },
  ...
  { value: 'CuidadoPersonal', label: 'Cuidado Personal', Help: 'Son los gastos relacionados con productos o servicios para la higiene, cuidado de la piel, cabello y bienestar personal, como cremas, jabones, entre otros.', visible: false, type: "number" },
  { value: 'DesayunosDiarios', label: 'Desayunos Diarios', Help: 'Es el gasto relacionado con los alimentos consumidos en el desayuno cada día, ya sea en casa o fuera de ella.', visible: false, type: "number" },
  ...
  { value: 'MesadaHijos', label: 'Mesada Hijos', Help: 'Es el dinero que se destina mensualmente a los hijos para cubrir sus necesidades o como un ahorro para su educación o bienestar.', visible: false, type: "number" },
...
export const hogar = [
  ...
  { value: 'ComprasCasa', label: 'Compras Casa', Help: 'Son los gastos asociados a la adquisición de artículos y productos para la casa, tales como electrodomésticos, muebles, decoración, utensilios de cocina, entre otros.', visible: false, type: "number" },
  ...
  { value: 'ServicioDomestico', label: 'Servicio Doméstico', Help: 'Es el costo de los servicios de limpieza, cocina u otros servicios domésticos proporcionados por empleados o agencias especializadas.', visible: false, type: "number" },
  { value: 'ServiciosPublicos', label: 'Servicios Públicos', Help: 'Son los gastos relacionados con los servicios públicos generales, como agua, luz, gas, telecomunicaciones y otros servicios proporcionados por el gobierno o empresas privadas.', visible: false, type: "number" },
  ...
  { value: 'PlataformasStremm', label: 'Plataformas Stremm', Help: 'Son los gastos asociados con servicios de streaming o plataformas de entretenimiento en línea, como Netflix, Spotify, Disney+, Amazon Prime, entre otros.', visible: false, type: "number" },
...
export const entretenimiento = [
  ...
  { value: 'eventos-sociales', label: 'Eventos Sociales', Help: 'Son los gastos asociados con la asistencia o participación en eventos sociales como fiestas, bodas, conciertos, entre otros.', visible: false, type: "number" },
  { value: 'fines-de-semana', label: 'Fines de Semana', Help: 'Es el gasto relacionado con actividades recreativas o salidas que realizas durante los fines de semana, como cenas, salidas al parque, etc.', visible: false, type: "number" },
  ...
  { value: 'reuniones-sociales', label: 'Reuniones Sociales', Help: 'Es el gasto asociado con las reuniones y encuentros sociales con amigos, familiares o colegas, que pueden incluir cenas, actividades recreativas o eventos en casa.', visible: false, type: "number" },
...
export const protecciones = [
  { value: 'AporteAPensionObligatoria', label: 'Aporte a Pensión Obligatoria', Help: 'Es el aporte obligatorio que haces a un fondo de pensiones para asegurar tu jubilación. Este pago es obligatorio por ley.', visible: false, type: "number" },
  { value: 'AporteASaludObligatoria', label: 'Aporte a Salud Obligatoria', Help: 'Es el aporte obligatorio al sistema de salud, que te garantiza acceso a servicios médicos y de salud según la legislación vigente.', visible: false, type: "number" },
  { value: 'SaludPrepagada', label: 'Salud Prepagada', Help: 'Es un tipo de seguro de salud privado que permite acceder a atención médica con mejores tiempos de respuesta y servicios adicionales.', visible: false, type: "number" },
  { value: 'SeguroDeContenidos', label: 'Seguro de Contenidos', Help: 'Es un seguro que cubre los daños o pérdida de tus bienes materiales en caso de eventos como robo, incendios o accidentes.', visible: false, type: "number" },
  { value: 'SeguroDeInvalidez', label: 'Seguro de Invalidez', Help: 'Es un seguro que cubre la pérdida de ingresos debido a una invalidez permanente o temporal que impida trabajar.', visible: false, type: "number" },
  { value: 'SeguroDeResponsabilidadCivil', label: 'Seguro de Responsabilidad Civil', Help: 'Es un seguro que cubre los daños a terceros causados por accidente, negligencia o mal manejo de tus bienes o actividades.', visible: false, type: "number" },
  { value: 'SeguroDeSalud', label: 'Seguro de Salud', Help: 'Es un seguro médico que cubre gastos de atención sanitaria, incluyendo consultas médicas, cirugías y otros servicios médicos.', visible: false, type: "number" },
  { value: 'SeguroDeVehiculo', label: 'Seguro de Vehículo', Help: 'Es un seguro que cubre los daños causados a tu vehículo o a otros vehículos en caso de accidentes, robos o daños a terceros.', visible: false, type: "number" },
  { value: 'SeguroDeVida', label: 'Seguro de Vida', Help: 'Es un seguro que protege a tus beneficiarios financieros en caso de fallecimiento, brindando un pago único o mensual.', visible: false, type: "number" },
  { value: 'SeguroExequial', label: 'Seguro Exequial', Help: 'Es un seguro que cubre los gastos de los servicios funerarios en caso de fallecimiento, aliviando los gastos para la familia.', visible: false, type: "number" },
  { value: 'SeguroVivienda', label: 'Seguro Vivienda', Help: 'Es un seguro que cubre daños en tu hogar, tales como incendios, terremotos, robos y otros eventos que puedan afectar tu propiedad.', visible: false, type: "number" },
...
export const descuentosnomina = [
  ...
  { value: 'RetencionEnLaFuente', label: 'Retención en la Fuente', Help: 'Es un descuento que realiza el empleador sobre tu salario, destinado al pago anticipado del impuesto sobre la renta.', visible: false, type: "number" },
  { value: 'AporteAFondoDeSolidaridad', label: 'Aporte a Fondo de Solidaridad', Help: 'Es un descuento destinado a un fondo de solidaridad para la población más vulnerable o para situaciones de emergencia nacional.', visible: false, type: "number" },
  { value: 'AporteAFondoDeSubsistencia', label: 'Aporte a Fondo de Subsistencia', Help: 'Es un descuento destinado a un fondo de subsistencia para situaciones de pobreza extrema o emergencia social.', visible: false, type: "number" },
  { value: 'OtrosDescuentos', label: 'Otros Descuentos', Help: 'Cualquier otro tipo de descuento relacionado con situaciones laborales, legales o acordadas que no encajen en las categorías anteriores.', visible: false, type: "number" },
...
export const educacion = [
  { value: 'BonoEstudiantil', label: 'Bono Estudiantil', Help: 'Es una ayuda económica otorgada para cubrir los costos de la educación, ya sea en nivel universitario, técnico o profesional.', visible: false, type: "number" },
  ...
  { value: 'LibrosYUtiles', label: 'Libros y útiles', Help: 'Este rubro cubre la compra de libros, material escolar y otros útiles necesarios para los estudios.', visible: false, type: "number" },
  { value: 'MatriculaColegio', label: 'Matrícula Colegio', Help: 'Corresponde al costo de la matrícula anual o semestral en una institución educativa de nivel escolar o preescolar.', visible: false, type: "number" },
  { value: 'MatriculaUniversidad', label: 'Matrícula Universidad', Help: 'Es el pago realizado para la inscripción y matrícula en una universidad, institución técnica o tecnológica.', visible: false, type: "number" },
  { value: 'PensionColegio', label: 'Pensión Colegio', Help: 'Este valor hace referencia a la pensión mensual que se paga por la educación escolar de un hijo o familiar.', visible: false, type: "number" },
...
export const financieros = [
  { value: 'CuatroXMil', label: '4 x Mil', Help: 'Es un impuesto que se aplica a las transacciones financieras realizadas en Colombia, conocido como el "gravamen a los movimientos financieros".', visible: false, type: "number" },
  { value: 'ComisionesPorAdministracion', label: 'Comisiones por Administración', Help: 'Son las tarifas que cobran las entidades financieras por la gestión y administración de productos como cuentas, fondos de inversión o tarjetas.', visible: false, type: "number" },
  { value: 'CuotaDeManejoTarjetaDebito', label: 'Cuota de Manejo Tarjeta Débito', Help: 'Es un costo asociado con el uso y mantenimiento de una tarjeta débito, que algunas entidades financieras aplican mensualmente.', visible: false, type: "number" },
  { value: 'CuotaManejoTarjetaCredito', label: 'Cuota Manejo Tarjeta de Crédito', Help: 'Es un cargo mensual que las entidades bancarias aplican por el uso de tarjetas de crédito, que cubre la administración de la cuenta.', visible: false, type: "number" },
